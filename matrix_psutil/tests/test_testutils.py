...
from matrix_psutil.tests import HAS_NET_CONNECTIONS_UNIX
from matrix_psutil.tests import HERE
...
from matrix_psutil.tests import fake_pytest
from matrix_psutil.tests import filter_proc_net_connections
...
class TestSyncTestUtils(PsutilTestCase):
    def test_wait_for_pid(self):
        ...
        with mock.patch(
            'matrix_psutil.tests.retry.__iter__', return_value=iter([0])
        ):
