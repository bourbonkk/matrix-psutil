...
class TestProcess(PsutilTestCase):
    ...
    def test_username_no_resolution(self):
        ...
        p = psutil.Process()
        with mock.patch(
            "matrix_psutil.pwd.getpwuid", side_effect=KeyError
        ) as fun:
    ...
    def test_name_long(self):
        ...
        with mock.patch(
            "matrix_psutil._psplatform.Process.name", return_value=name
        ):
            with mock.patch(
                "matrix_psutil._psplatform.Process.cmdline",
...
class TestSystemAPIs(PsutilTestCase):
    ...
    def test_pid_exists_let_raise(self):
        ...
        with mock.patch(
            "matrix_psutil._psposix.os.kill",
    ...
    def test_os_waitpid_let_raise(self):
        ...
        with mock.patch(
            "matrix_psutil._psposix.os.waitpid",
            side_effect=OSError(errno.EBADF, ""),
        ) as m:
            with pytest.raises(OSError):
    ...
    def test_os_waitpid_bad_ret_status(self):
        ...
        with mock.patch(
            "matrix_psutil._psposix.os.waitpid", return_value=(1, -1)
        ) as m:
