...
class TestProcessIter(PsutilTestCase):
    ...
    def test_attrs(self):
        ...
        with mock.patch(
            "matrix_psutil._psplatform.Process.cpu_times",
...
class TestCpuAPIs(PsutilTestCase):
    ...
    def test_cpu_count_none(self):
        ...
        for val in (-1, 0, None):
            with mock.patch(
                'matrix_psutil._psplatform.cpu_count_logical', return_value=val
            ) as m:
                assert psutil.cpu_count() is None
                assert m.called
            with mock.patch(
                'matrix_psutil._psplatform.cpu_count_cores', return_value=val
            ) as m:
...
class TestDiskAPIs(PsutilTestCase):
    ...
    def test_disk_io_counters_no_disks(self):
        ...
        with mock.patch(
            'matrix_psutil._psplatform.disk_io_counters', return_value={}
        ) as m:
...
class TestNetAPIs(PsutilTestCase):
    ...
    def test_net_io_counters_no_nics(self):
        ...
        # https://github.com/giampaolo/psutil/issues/1062
        with mock.patch(
            'matrix_psutil._psplatform.net_io_counters', return_value={}
        ) as m:
    ...
    def test_net_if_addrs_mac_null_bytes(self):
        ...
        with mock.patch(
            'matrix_psutil._psplatform.net_if_addrs', return_value=ret
        ) as m:
    ...
    def test_net_if_stats_enodev(self):
        ...
        with mock.patch(
            'matrix_psutil._psutil_posix.net_if_mtu',
...
class TestSensorsAPIs(PsutilTestCase):
    ...
    def test_sensors_temperatures_fahreneit(self):
        ...
        with mock.patch(
            "matrix_psutil._psplatform.sensors_temperatures", return_value=d
        ) as m:
